module.exports = async function (self) {
	self.setVariableDefinitions([
		...
		{ variableId: 'notes', name: 'Current slide notes (ASCII)' },
		{ variableId: 'notesSnip', name: 'Current slide notes (snippet, ASCII)' },
		{ variableId: 'notesUtf8', name: 'Current slide notes (UTF8)' },
		{ variableId: 'notesSnipUtf8', name: 'Current slide notes (snippet, UTF8)' },
